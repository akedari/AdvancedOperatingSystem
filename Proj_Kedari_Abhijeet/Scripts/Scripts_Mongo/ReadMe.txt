...
3. copy the MongoInstall.sh script (/home/abhijeet/workspace/Prog2_Kedari_Abhijeet/MongoDB/MongoDBPeer) to newly created server instance (via FileZilla OR pscp 
   [pscp -h newHost.txt  -O StrictHostKeyChecking=no -r /home/abhijeet/workspace/Prog2_Kedari_Abhijeet/MongoDB/MongoDBPeer/MongoInstall.sh /home/ubuntu/])
...
4. copy the code from local machine (/home/abhijeet/workspace/Prog2_Kedari_Abhijeet/MongoDB/MongoDBPeer) to newly created server instance
...
7. On you local machine create the config file with public IP Addressess of all the instances. This config file will be associated with Evaluation class (/home/abhijeet/workspace/
   Prog2_Kedari_Abhijeet/MongoDB/MongoDBPeer/src/MongoTest.java)
   AFter creating config file copy it to all servers instances
   pscp -h host.txt -O StrictHostKeyChecking=no -r /home/abhijeet/workspace/Prog2_Kedari_Abhijeet/MongoDB/MongoDBPeer/config.properties /home/ubuntu/MongoDB/MongoDBPeer

   (host.txt this file contains ips of server instances we created)

8. type below command on local machine where (/home/abhijeet/workspace/Prog2_Kedari_Abhijeet/MongoDB/MongoDBPeer/src/MongoTest.java)
